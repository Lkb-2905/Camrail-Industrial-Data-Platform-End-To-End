...
## 📸 Complément Démo : Pipeline ML
Le pipeline PM-D génère `processed_telemetry.csv` et `rf_failure_predict.joblib`. Captures d'exécution :

![Génération données](../docs/screenshots/07_pmd_generation_donnees.png)  
![Entraînement modèle](../docs/screenshots/08_pmd_model_training.png)
